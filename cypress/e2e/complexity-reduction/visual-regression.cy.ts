...
describe('복잡도 감소 시각적 회귀 테스트 (Visual Regression)', () => {
  ...
  describe('Dashboard Widget 시각적 일관성', () => {
    ...
    it('should preserve hover states visual consistency', () => {
      ...
      cy.get('[data-testid="projects-stat"]')
        .screenshot('dashboard-stats-hover-state', {
          capture: 'viewport',
          scale: false,
          disableTimersAndAnimations: true
        });
    ...
    it('should maintain responsive layout at different breakpoints', () => {
      ...
      cy.get('[data-testid="dashboard-widget"]')
        .screenshot('dashboard-tablet-1024', {
          capture: 'viewport'
        });
      ...
      cy.viewport(375, 667);
      cy.get('[data-testid="dashboard-widget"]')
        .screenshot('dashboard-mobile-375', {
          capture: 'viewport'
        });
    });
  });
  ...
  describe('Calendar Widget 시각적 일관성', () => {
    ...
    it('should maintain calendar grid layout and event positioning', () => {
      ...
      // 캘린더 전체 뷰 스크린샷
      cy.get('[data-testid="calendar-widget"]')
        .screenshot('calendar-widget-baseline', {
          capture: 'viewport',
          scale: false,
          disableTimersAndAnimations: true
        });
    ...
    it('should preserve event modal visual consistency', () => {
      ...
      // 모달 스크린샷
      cy.get('[role="dialog"]')
        .screenshot('calendar-event-modal-baseline', {
          capture: 'viewport',
          scale: false
        });
    });
    ...
    it('should maintain date navigation visual states', () => {
      ...
      cy.get('[data-testid="calendar-widget"]')
        .screenshot('calendar-prev-month-state', {
          capture: 'viewport'
        });
      ...
      cy.get('[data-testid="calendar-widget"]')
        .screenshot('calendar-next-month-state', {
          capture: 'viewport'
        });
    });
  });
  ...
  describe('Video Feedback Widget 시각적 일관성', () => {
    ...
    it('should maintain video player and feedback panel layout', () => {
      ...
      // 전체 비디오 피드백 위젯 스크린샷
      cy.get('[data-testid="video-feedback-widget"]')
        .screenshot('video-feedback-widget-baseline', {
          capture: 'viewport',
          scale: false,
          disableTimersAndAnimations: true
        });
    ...
    it('should preserve comment thread visual hierarchy', () => {
      ...
      cy.get('[data-testid="feedback-panel"]')
        .screenshot('video-feedback-comments-baseline', {
          capture: 'viewport',
          scale: false
        });
    });
    ...
    it('should maintain comment input form visual consistency', () => {
      ...
      cy.get('[data-testid="comment-input"]')
        .type('새로운 피드백 댓글 테스트입니다.');
      
      // 입력 상태 스크린샷
      cy.get('[data-testid="comment-form"]')
        .screenshot('video-feedback-comment-input-state', {
          capture: 'viewport',
          scale: false
        });
    });
    ...
    it('should preserve video control UI visual states', () => {
      ...
      cy.get('[data-testid="video-player"]')
        .screenshot('video-player-playing-state', {
          capture: 'viewport',
          scale: false
        });
      ...
      cy.get('[data-testid="video-controls"]')
        .screenshot('video-controls-hover-state', {
          capture: 'viewport',
          scale: false
        });
    });
  ...
  describe('Navigation 시각적 일관성', () => {
    it('should maintain sidebar visual states across pages', () => {
      ...
      cy.get('[data-testid="sidebar"]')
        .screenshot('sidebar-dashboard-state', {
          capture: 'viewport',
          scale: false
        });
      ...
      cy.get('[data-testid="sidebar"]')
        .screenshot('sidebar-calendar-state', {
          capture: 'viewport',
          scale: false
        });
      ...
      cy.get('[data-testid="sidebar"]')
        .screenshot('sidebar-collapsed-state', {
          capture: 'viewport',
          scale: false
        });
    });
    ...
    it('should preserve breadcrumb visual hierarchy', () => {
      ...
      cy.get('[data-testid="breadcrumb"]')
        .screenshot('breadcrumb-baseline', {
          capture: 'viewport',
          scale: false
        });
    });
  ...
  describe('에러 상태 시각적 일관성', () => {
    it('should maintain error boundary visual consistency', () => {
      ...
      cy.get('[data-testid="error-boundary"]')
        .screenshot('error-boundary-baseline', {
          capture: 'viewport',
          scale: false
        });
    });
  ...
  describe('접근성 포커스 상태 시각적 일관성', () => {
    it('should maintain keyboard focus indicators visual consistency', () => {
      ...
      cy.get('[tabindex="0"], button, input, select, textarea, [href]')
        .each(($el) => {
          cy.wrap($el).focus();
          cy.wait(100);
