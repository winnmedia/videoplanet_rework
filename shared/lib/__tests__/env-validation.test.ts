...
describe('환경변수 검증 시스템', () => {
  ...
  describe('validateFrontendEnv', () => {
    it('완전한 환경변수 설정 시 정상 검증되어야 함', () => {
      ...
      process.env.NEXT_PUBLIC_PRODUCTION_DOMAIN = 'videoplanet.up.railway.app'
      process.env.NEXT_PUBLIC_APP_URL = 'https://videoplanet-vlanets-projects.vercel.app'
      process.env.NEXT_PUBLIC_API_BASE = 'https://videoplanet.up.railway.app'
