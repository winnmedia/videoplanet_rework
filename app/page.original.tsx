...
// Migrated from SASS to Tailwind CSS for modern styling
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen relative">
      {/* 헤더 */}
      <header className="absolute left-0 top-0 w-full z-[1000]">
        <div className="max-w-[1200px] w-[96%] mx-auto py-5 flex justify-between items-center">
          <div className="logo">
            <Image 
          ...
          <nav className="flex items-center gap-5">
            <div className="flex gap-4">
              <a
                ...
                className="w-10 h-10 rounded-full cursor-pointer block transition-transform duration-300 hover:scale-110 bg-[url('/images/Common/yt_icon02.svg')] bg-center bg-cover"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-full cursor-pointer block transition-transform duration-300 hover:scale-110 bg-[url('/images/Common/insta_icon02.svg')] bg-center bg-cover"
                aria-label="VLANET 인스타그램 방문"
              >
                <span className="sr-only">인스타그램</span>
              </a>
            </div>
            <button onClick={() => router.push('/login')} className="bg-gradient-to-br from-blue-600 to-blue-700 text-white border-none rounded-full px-8 py-3 text-base font-semibold cursor-pointer transition-all duration-300 hover:-translate-y-0.5 hover:shadow-lg hover:shadow-blue-600/30">
              로그인
            </button>
          </nav>
        </div>
      ...
      <main>
        {/* 비주얼 섹션 */}
        <section className="bg-[url('/images/Home/new/visual-bg.png')] bg-no-repeat bg-center bg-cover pt-36 pb-20">
          <div className="max-w-[1300px] w-[96%] mx-auto flex justify-center items-center gap-24">
            <div className="flex-none w-[410px] text-white">
              <h1 className="text-6xl font-semibold leading-tight">
                영상 콘텐츠<br />
                협업의 신.세.계<br />
                <span className="inline-block bg-blue-500 px-3 mt-3">브이래닛으로</span><br />
                <span className="inline-block bg-blue-500 px-3 mt-3">당장 이주하세요!</span>
              </h1>
              <p className="text-2xl font-normal text-white/80 mt-8 leading-relaxed">
                쉽고 정확한 영상 피드백 툴<br />
