          ...
          >
            {displayedItems.map((item) => (
              ...
              >
                ...
                {/* 프로젝트 색상 스와치 */}
                <div 
                  className="flex-shrink-0 w-4 h-4 rounded-sm border-2 border-white shadow-sm"
        ...
        <div className="flex items-center justify-between mt-4 pt-4 border-t border-gray-200">
          <div className="flex items-center gap-2 text-xs text-gray-500">
            <div className="flex items-center gap-1">
              <div className="w-3 h-3 bg-green-400 rounded opacity-30" />
              <span>진행률</span>
            </div>
            <div className="flex items-center gap-1">
              <div className="w-3 h-3 border-2 border-dashed border-red-500 bg-red-100 rounded" />
              <span>충돌</span>
            </div>
          </div>
